...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002203356678').split()]
...
AUTH_CHANNELS = [int(ch) for ch in environ.get("AUTH_CHANNELS", "-1002918900365").split() if ch and id_pattern.match(ch)]
AUTH_REQ_CHANNELS = [int(ch) for ch in environ.get("AUTH_REQ_CHANNELS", "-1002237171878").split() if ch and id_pattern.match(ch)]
REQST_CHANNEL = int(ch) if (ch := environ.get("REQST_CHANNEL", "-1002134871596")) and id_pattern.search(ch) else None
SUPPORT_CHAT_ID = int(ch) if (ch := environ.get("SUPPORT_CHAT_ID", "-1002134871596")) and id_pattern.search(ch) else None

OWNER = int(os.environ.get("OWNER", "949657126"))
...
UPDATE_CHANNEL = int(environ.get('UPDATE_CHANNEL', '-1002207550488'))
...
TMDB_API_KEY = environ.get('TMDB_API_KEY', '1ba98a04426a253bc7cb4be687abe2ed')
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/ML_Files/38")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/ML_Files/38")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/ML_FILES/38")
SHORTENER_API = environ.get("SHORTENER_API", "e59d2744661a2cc1aaeef04b42611a42117e3988")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "urllinkshort.in")
SHORTENER_API2 = environ.get("SHORTENER_API2", "e59d2744661a2cc1aaeef04b42611a42117e3988")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "urllinkshort.in")
SHORTENER_API3 = environ.get("SHORTENER_API3", "e59d2744661a2cc1aaeef04b42611a42117e3988")
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', 'https://movie-loverzz-bot5-18ba1d7592a6.herokuapp.com/'))
FQDN = str(getenv('FQDN', BIND_ADRESS)) if not ON_HEROKU or getenv('FQDN') else APP_NAME+'.herokuapp.com'
URL = "https://movie-loverzz-bot5-18ba1d7592a6.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else "https://{}/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://movie-loverzz-bot5-18ba1d7592a6.herokuapp.com/".format(FQDN)
else:
    URL = "https://movie-loverzz-bot5-18ba1d7592a6.herokuapp.com/".format(FQDN)
